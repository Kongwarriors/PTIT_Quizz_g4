 ...
 * @author PC
 */
@WebServlet(name="UpdateQuestion", urlPatterns={"/api-update-question"})
...
//        exam_id = qdb.getQuestionById1(id).getExam_id();
            Question newQuestion = new Question();
            newQuestion.setContent(content);
            newQuestion.setDifficulty(difficulty);
            newQuestion.setId(id);
            qdb.update(newQuestion);
            out.println("{\"message\": \"Question updated successfully.\"}");
