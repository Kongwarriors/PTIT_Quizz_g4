...
//        processRequest(request, response);
        ...
        for(Exam exam : exams){
            ...
            jsonExam.put("id", exam.getId());
            jsonExam.put("title", exam.getTitle());
            jsonExam.put("status", exam.getStatus());
            if(exam.getStatus().equalsIgnoreCase("scheduled")){
                log(exam.getScheduleTime().toString());
                jsonExam.put("scheduleTime", exam.getScheduleTime());
            }
            JSONArray jsonQuestions = new JSONArray();
            for (ExamQuestion examQuestion : exam.getExamQuestions()) {
                JSONObject jsonQuestion = new JSONObject();
                jsonQuestion.put("questionId", examQuestion.getQuestionId());
            ...
            jsonExam.put("questions", jsonQuestions);
